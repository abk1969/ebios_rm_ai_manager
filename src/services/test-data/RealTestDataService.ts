/**
 * SERVICE DE DONNÉES DE TEST PROCESSÉES
 * Génère et gère des données processées pour les tests EBIOS RM
 */
...
export class RealTestDataService {
   ...
   */
  async createTestMission(missionName: string = 'Mission EBIOS RM Test'): Promise<string> {
    ...
    const mission: TestMission = {
      ...
      organization: 'Organisation de Test EBIOS RM',
